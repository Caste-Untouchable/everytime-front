...
class SecretBoardWrite extends StatefulWidget {
  const SecretBoardWrite({super.key});

  @override
  State<SecretBoardWrite> createState() => SecretBoardWriteState();
}

class SecretBoardWriteState extends State<SecretBoardWrite> {
  bool isAnonym = false;
